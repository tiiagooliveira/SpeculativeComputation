 ...
 */
public class NonmedicationManager {
    ...
    private static NonmedicationManager singleton = new NonmedicationManager();


    public static NonmedicationManager getInstance()
    {
        return singleton;
    }

    public NonmedicationBean createNonmedicationBean()
    {
        return new NonmedicationBean();
    }
    public NonmedicationBean getNonmedicationBeanByID(String id){
        Connection c = null;
        PreparedStatement statement = null;
        StringBuilder sql = null;
        NonmedicationBean bean= NonmedicationManager.getInstance().createNonmedicationBean();
        ResultSet rs = null;
        ...
        try {
            ...
            sql.append("SELECT * FROM nonmedication WHERE idnonmedication=");
            sql.append(id);
            statement=c.prepareStatement(sql.toString());
            rs = statement.executeQuery();
            while(rs.next()){
                bean.setIdnonmedication(rs.getLong("idnonmedication"));
    ...
    public int deleteNonmedicationBeanById(Long id) throws DAOException {
        PreparedStatement statement = null;
        ...
        try {
            sql.append("DELETE FROM nonmedication WHERE idnonmedication =");
            sql.append(id);
    ...
    public NonmedicationBean insert(NonmedicationBean bean) throws DAOException
    {
        Connection c = null;
        ...
        try
        {
            ...
            sql = new StringBuilder();
            ps = null;
            sql.append("INSERT into nonmedication(");
            sql.append(FIELDS);
            sql.append(") VALUES (");
    ...
    public NonmedicationBean update(NonmedicationBean bean) throws DAOException {
        ...
        try
        {
            ...
            sql.append("UPDATE nonmedication SET ");
            ...
            sql.append(bean.getIdnonmedication());
